...
export function SiteHeader() {
  ...
  const linkBase =
    "relative inline-flex items-center gap-1 py-1 transition-transform will-change-transform hover:scale-[1.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60";
  const underline =
