  ...
  return (
    <section id="testimonios" className="section">
      <div className="container-narrow">
        <h2 className="text-3xl font-bold mb-6 heading-accent">Testimonios</h2>
        {loading ? <p>Cargando…</p> : (
          reviews.length ? (
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {reviews.map(r => (
                <Card key={r.id} className="p-6 transition-transform hover:-translate-y-1 hover:scale-[1.05] hover:shadow-xl motion-reduce:transform-none">
