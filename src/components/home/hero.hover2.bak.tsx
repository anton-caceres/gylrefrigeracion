      ...
      <div className="container-narrow relative">
        <MotionReveal className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild className="transition-transform hover:scale-[1.03] active:scale-[0.98]">
              <a href={waLink("Hola G&L Refrigeración, necesito asesoramiento.")} target="_blank" rel="noopener noreferrer">
                Contactanos ahora
              </a>
            </Button>
            <Button variant="outline" asChild className="transition-transform hover:scale-[1.03] active:scale-[0.98]">
